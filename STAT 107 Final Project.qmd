...
## Analysis #2 Factors Influencing Job Satisfaction
...
```{r}
  ...
  model <- lm(Job.Satisfaction ~ Gender + Family.Influence + Work.Life.Balance + Job.Security +   Salary, data = data_clean)
  ...
  # lOoking at job satisfaction vs changing occupation
    ...
    ggplot(data_clean, aes(x = Likely.to.Change.Occupation, y = Job.Satisfaction)) +
