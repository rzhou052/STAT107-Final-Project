...
Separate family influence into factors based on level, display specific occupations
...
Create a logistic regression model (glm) to analyze the influence of gender, family influence, current occupation, job security on career change interest.
